...
Wishing you all the very best for what's ahead — go out there and do great things.`,
  },
  {
    ...
    role: 'Batch 2K22 — 2K26',
    emoji: '🫶🏻',
    message: `Thank you so much for your lovely words and for organizing such a beautiful farewell for us. We truly appreciate all your efforts, care, and the happiness you gave us on that day. There's absolutely nothing to feel sorry about — everything was wonderful and we really enjoyed every moment.

We will always cherish the memories we made together — the fun, conversations, and bonding we shared. You all made our journey even more special. ✨

We will miss you all too, and yes — let's definitely keep this beautiful senior-junior bond forever. ❤️‍🩹 Stay happy and keep smiling always!`,
  },
  {
    name: 'T. Uday Pavan',
    role: 'Batch 2K22 — 2K26',
